...
- To map a large number of email addresses, phone numbers, or respective hashes, send them in _sequential_ batches with a maximum batch size of 5,000 items per batch.
...
| `email_hash`   | string array | Conditionally Required | The list of [Base64-encodedd SHA-256](../../README.md#email-address-hash-encoding) hashes of [normalized](../../README.md#email-address-normalization) email addresses. |
...
| `phone_hash`   | string array | Conditionally Required | The list of [Base64-encodedd SHA-256](../../README.md#email-address-hash-encoding) hashes of [normalized](../../README.md#phone-number-normalization) phone numbers.    |
