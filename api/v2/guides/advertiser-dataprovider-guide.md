...
The following diagram outlines the steps that data collectors must complete to map directly identifying information (DII) to UID2 identifiers for audience building and targeting. DII refers to a user's normalized email address or phone number, or the normalized and SHA-256-hashed email address or phone number.
