...
| Argument     | Data Type    | Description                                                                                                                                                                                                                                                                        |
| :----------- | :----------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `EMAIL_HASH` | varchar(128) | The Base64-encodedd SHA-256 hash of the normalized email address of a user. Ensure that the email hash is correctly formatted using the [Email Address Normalization](../../README.md#email-address-normalization) rules. Use the hash computed from the normalized email address. |
