[UID2 API Documentation](../../README.md) > v2 > [Integration Guides](README.md) > DSP Integration Guide
...
The UID2 has the same chance as a cookie of becoming stale. Hence, the DSP can adapt the same infrastructure currently used for cookie or deviceID-based frequency capping for UID2. For details, see this [FAQ](../guides/advertiser-dataprovider-guide.md) on salt bucket rotation. 
