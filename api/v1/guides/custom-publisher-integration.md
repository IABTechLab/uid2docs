...
>TIP: To facilitate the process of establishing client identity using UID2 and retrieving advertising tokens, consider using the [Client-Side JavaScript SDK v1](../sdks/client-side-identity-v1.md). For details, see [UID2 SDK Integration Guide](./publisher-client-side.md).
