...
| :--- | :--- |
| [Publisher - Standard](./publisher-client-side.md) | This integration guide for publishers covers standard web integration scenarios that utilize the [Client-Side Identity JavaScript SDK](../sdks/client-side-identity-v1.md). |
