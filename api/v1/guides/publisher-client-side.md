...
To facilitate the process of establishing client identity using UID2 and retrieving advertising tokens, the web integration steps provided in this guide rely on the [Client-Side Identity JavaScript SDK](../sdks/client-side-identity-v1.md), also known as the UID2 SDK. See also TBD XREF to sample app.
...
2. Store the returned `refresh_token` returned for use in teh following step.
