...
To identify the UID2s that you must regenerate, use the `UID2_SALT_BUCKETS` view from UID2 Share.
...
To determine which UIDs need regeneration, compare the timestamps of when they were generated to the most recent timestamp of the second-level salt bucket update.
