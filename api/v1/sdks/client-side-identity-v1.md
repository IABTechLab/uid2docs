...
>IMPORTANT: Version 1 of the UID2 SDK supports the version 0 cookies for user session continuity, but this version of the SDK is not backward-compatible and requires the code changes listed below. 
