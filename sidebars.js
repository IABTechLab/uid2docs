...

  {
    ...
    items: [
            ...
            items: [
              {
                ...
                collapsed: true,
                items: ["guides/integration-snowflake-previous"],
              },
...

      {
        ...
        collapsed: true,
        items: ["guides/dsp-guide", "guides/integration-dsp-no-sdk"],
      },
    ...
    items: [
      {
        ...
        collapsed: true,
        items: ["sdks/sdk-ref-javascript-v3"],
      },
...
const sidebars = {
  ...
  sidebarAdvertisers: removeItems(
    fullSidebar,
    "overviews/overview-publishers",
    "overviews/overview-dsps",
    "overviews/overview-data-providers",
  ...
  sidebarDataProviders: removeItems(
    fullSidebar,
    "overviews/overview-publishers",
    "overviews/overview-advertisers",
    "overviews/overview-dsps",
