...
Check out the latest new or significantly updated documentation resources for UID2.

### New: Private Operator Guide for Google Confidential Space 

30 September 2023

This completely new guide provides information for setting up the UID2 Operator Service in [Confidential Space](https://cloud.google.com/confidential-computing#confidential-space), a confidential computing option from the Google Cloud Platform.
...
### Update: Clarification re Normalization and Encoding Rules
...
A new guide for publishers that provides information about the UID2 Interactive Media Ads (IMA) Plugin for Android. This plugin enables publishers who use the Google Interactive Media Ads (IMA) SDK for Android to send [UID2 tokens](../ref-info/glossary-uid.md#gl-uid2-token) as secure signals in ad requests from Android apps.
...
A new guide for publishers that provides information about the UID2 IMA Plugin for iOS. This plugin enables publishers who use the Google Interactive Media Ads SDK for iOS to send [UID2 tokens](../ref-info/glossary-uid.md#gl-uid2-token) as secure signals in ad requests from iOS apps.
...
A new guide for publishers that provides information about the UID2 Google Mobile Ads (GMA) Plugin for Android. This plugin enables publishers who use the Google Mobile Ads (GMA) SDK to send [UID2 tokens](../ref-info/glossary-uid.md#gl-uid2-token) as secure signals in ad requests from Android apps.
...
A new guide for publishers that provides information about the UID2 GMA Plugin for iOS. This plugin enables publishers who use the Google Mobile Ads (GMA) SDK to send [UID2 tokens](../ref-info/glossary-uid.md#gl-uid2-token) as secure signals in ad requests from iOS apps.

For details, see [UID2 GMA Plugin for iOS Integration Guide](../guides/mobile-plugin-gma-ios.md).

### New Language: UID2 Website in Japanese

3 August 2023

The entire UID2 website is now available in Japanese as well as English.

For details, use the language drop-down on any site page, or go straight to the [Unified ID 2.0 page in Japanese](https://unifiedid.com/ja/docs/intro).

### New: UID2 Portal Documentation

3 August 2023

We published several new documentation pages to help users navigating the new UID2 Portal user interface, where you can manage aspects of your UID2 account.

For details, see [UID2 Portal](/docs/category/uid2-portal).

### New and Updated Documentation for UID2 Sharing

3 August 2023

We published several new and updated documents to support use of the new UID2 sharing feature. Documents include:

- [UID2 Sharing](/docs/category/uid2-sharing): A set of new pages providing information relating to UID2 sharing, including an overview, use cases, implementation instructions, best practices, and more.
- SDK updates: Updates to the four server-side SDKs to support the Sharing feature:
...
A new guide for publishers who want to directly integrate with UID2 and generate UID2 tokens (advertising tokens) to be passed by Prebid in the RTB bid stream.
