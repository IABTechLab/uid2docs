...
Sample pages for passing UID2 tokens to Google Ad Manager (GAM) via Secure Signals. For more details, see [Google Ad Manager Secure Signals Guide](https://unifiedid.com/docs/guides/integration-google-ss).
