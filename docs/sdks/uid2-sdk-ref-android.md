...
You can use the UID2 SDK for Android to facilitate the process of generating or establishing client identity using UID2 and retrieving advertising tokens on Android devices for bid stream use.
