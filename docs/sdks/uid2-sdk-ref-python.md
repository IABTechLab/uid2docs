...
If you're using standard integration (client and server) (see [UID2 SDK for JavaScript Integration Guide](../guides/integration-javascript-advanced.md)), follow this step:
