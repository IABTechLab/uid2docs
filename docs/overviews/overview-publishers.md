...
| Server-Side Integration Guide  | [Publisher Integration Guide, Server-Only (Without SDK)](../guides/custom-publisher-integration.md) | This integration guide is for publishers that do not use the [UID2 SDK for JavaScript](../sdks/client-side-identity.md). | Publishers |
