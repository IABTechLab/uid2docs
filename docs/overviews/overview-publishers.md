...
| iOS | [UID2 SDK for iOS and tvOS Reference Guide](../sdks/uid2-sdk-ref-ios.md) | iOS and tvOS SDK reference is for publishers who want to generate or establish client identity using UID2 and retrieve advertising tokens on iOS devices. |
