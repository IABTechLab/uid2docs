...
| Mobile: GMA for iOS | [UID2 GMA Plugin for iOS Integration Guide](../guides/mobile-gma-ios.md) | This integration guide enables publishers that use the Google Mobile Ads (GMA) SDK to include UID2 data in ad requests from their iOS apps. | Publishers |
| Mobile: GMA for Android | [UID2 GMA Plugin for Android Integration Guide](../guides/mobile-gma-android.md) | This integration guide enables publishers that use the Google Mobile Ads (GMA) SDK to include UID2 data in ad requests from their Android apps. | Publishers |
