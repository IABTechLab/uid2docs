...
| JavaScript Client-Side Integration  | [Standard Client-Side JavaScript Integration Guide](../guides/integration-javascript-standard.md) | This integration guide for publishers covers web integration without using the Express Integration method, such as generating UID2 tokens on the server side.                                                                                                          | Publishers |
