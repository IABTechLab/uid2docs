...
| Direct Integration Tips | [DSP Direct Integration Tips](../guides/integration-dsp-no-sdk.md) | Guidance for DSPs who prefer to integrate without using one of the UID2 SDKs. |
