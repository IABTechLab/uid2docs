...
The UID2 token can be matched against other instances of online activity by the same individual, but can never be used to determine the original personal information. It's completely anonymous, and yet consistent.
