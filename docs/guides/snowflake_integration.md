...
The Snowflake integration for UID2 is for any xxxxxxxxxxxxx who are using Snowflake (**GWH_KT how do we say that? For their data integration solution? And who is it for -- before sharing, and with sharing? Also audiences section general.**).

| Audience | Functions |
| :--- | :--- |
| Advertisers | Supports identity mapping. |
| Data Providers | Supports identity mapping. |
...
For an example, see [UID2 Sharing Example](#uid2).
