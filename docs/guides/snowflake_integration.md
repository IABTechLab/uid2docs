...
The following table summarizes the functionality available with the UID2 Snowflake integration, for any advertisers or data providers who are managing their data in Snowflake.
