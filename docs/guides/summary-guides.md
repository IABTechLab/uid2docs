...
| [Publisher Integration Guide, Server-Only](custom-publisher-integration.md) | This integration guide is for publishers that do not use the [Client-Side JavaScript SDK (v2)](../sdks/client-side-identity.md). |
