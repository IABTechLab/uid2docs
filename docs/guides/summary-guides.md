...
| [JavaScript Express Integration Guide](integration-javascript.md)           | This integration guide for publishers who want to integrate with UID2 with only TypeScript/JavaScript changes on their websites with minimum effort.                                                                                                                   |
