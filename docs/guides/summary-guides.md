...
| [JavaScript Express Integration Guide](publisher-client-side.md)           | This integration guide for publishers who want to integrate with UID2 with only JavaScript changes on their websites with minimum effort.                                                                                                                              |
...
| [UID2 SDK for JavaScript Integration Guide](integration-javascript-advanced.md)       | This integration guide for publishers covers standard web integration scenarios that use the UID2 SDK for JavaScript.                                                                                                                                                  |
