...
- HTTP endpoints: [POST&nbsp;/identity/map (v2)](../endpoints/post-identity-map-v2.md). For details, see [Generate Raw UID2s from DII](integration-advertiser-dataprovider-endpoints.md#1-generate-raw-uid2s-from-dii).
