...
This documentation is for the UID2 IMA Plugin for Android version 1.5.0 and later.
...
1. [UID2 IMA Plugin for Android v1.5.0](https://central.sonatype.com/artifact/com.uid2/uid2-android-sdk-ima)
...
```js
implementation 'com.uid2:uid2-android-sdk-ima:1.5.0'
```
