...
UID2 を使用したクライアント ID の確立と Advertising Token の取得を容易にするため、本ガイドで提供する Web インテグレーション手順では、UID2 SDK とも呼ばれる [Client-Side Identity JavaScript SDK](../sdks/client-side-identity.md) を使用しています。
