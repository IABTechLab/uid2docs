...
- コンテンツパブリッシャーのインテグレーション手順については、[Server-Side Integration Guide for JavaScript](../guides/integration-javascript-standard.md) を参照してください。
...
Web インテグレーションの詳細については、[Server-Side Integration Guide for JavaScript](../guides/integration-javascript-standard.md) を参照してください。
