...
:::tip
If you're using Prebid.js with the UID2 Identity Module (see [Prebid Integration Guide]((../guides/integration-prebid))), or with another product that has UID2 support, you probably don't need to use the SDK at all.
:::
