...
Related information:
- For integration steps for content publishers, see [JavaScript Express Integration Guide](../guides/publisher-client-side.md). 
...
For more detailed web integration steps, see [JavaScript Express Integration Guide](../guides/publisher-client-side.md).
