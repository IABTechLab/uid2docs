...
:::note
パブリッシャーの場合、Client-Side に UID2 を実装しているなら、認証と認可は Prebid.js ([Client-Side Integration Guide for Prebid.js](../guides/integration-prebid-client-side.md) を参照) や JavaScript SDK ([Client-Side Integration Guide for JavaScript](../guides/integration-javascript-client-side.md) を参照) などの実装によって自動的に管理されます。
:::
