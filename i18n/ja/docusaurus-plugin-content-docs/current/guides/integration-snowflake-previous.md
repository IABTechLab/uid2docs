...
以下の表は、`NULL` または不適切にフォーマットされたメールの `NULL` 値を含む、レスポンスの各項目を識別しています。
...
以下の表は、`NULL` または無効な電話番号の `NULL` 値を含む、レスポンスの各項目を識別しています。
...
以下の表は、`NULL` ハッシュの `NULL` 値を含む、レスポンスの各項目を識別しています。
