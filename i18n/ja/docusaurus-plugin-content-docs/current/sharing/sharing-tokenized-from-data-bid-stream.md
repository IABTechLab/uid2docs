...
:::tip
SDK に関する詳細は、[SDK Reference Guides](../sdks/sdk-ref-guides.md) を参照してください。パブリッシャー向けのインテグレーションアプローチの詳細は、[Publisher Integrations](../guides/summary-guides.md#publisher-integrations) を参照してください。
:::
