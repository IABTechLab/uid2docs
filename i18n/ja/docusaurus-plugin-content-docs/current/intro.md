...
| :-------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Buy-Side**<br/>[Overview](workflows/workflow-overview-buy-side.md)              | ビッドストリームで UID2 Token の取引を行う DSP。                                                                                                                                                                                                         | [DSP Integration Guide](guides/dsp-guide.md)                                                                                                                                                     |
| **Data Provider**<br/>[Overview](workflows/workflow-overview-3p-data-provider.md) | ユーザーデータを収集し、DSP にプッシュする組織。                                                                                                                                                                                                         | [Advertiser/Data Provider Integration Guide](guides/advertiser-dataprovider-guide.md)                                                                                                            |
| **Supply-Side**<br/>[Overview](workflows/workflow-overview-supply-side.md)        | SSP を介して UID2 Token をビッドストリームに伝播する組織。<br/>NOTE: パブリッシャーは、[Client-Side JavaScript SDK (v2)](sdks/client-side-identity.md) を活用するか、独自のカスタムで Server-Only インテグレーションを行うかを選択できます。 | [Client-Side JavaScript SDK Integration Guide](guides/publisher-client-side.md)<br/>[Publisher Integration Guide, Server-Only (Without SDK)](guides/custom-publisher-integration.md) |
...
![The UID2 Ecosystem](workflows/images/UID2-workflows-ja.jpg)
