...
| [Endpoints](endpoints/summary-endpoints.md) | ID トークンを管理し、メールアドレス、電話番号、またはハッシュを UID2 にマッピングし、UID2 の生成に使用されるソルトバケット ID を管理するための API リファレンス。<br/>NOTE: インテグレーション環境と本番環境では、異なる [API keys](ref-info/glossary-uid.md#gl-api-key) が必要です。 |
